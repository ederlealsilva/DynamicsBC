codeunit 5802 "Inventory Posting To G/L"
{
    ...
    [IntegrationEvent(TRUE, TRUE)]
    local procedure OnAfterInitTempInvtPostBuf()
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetAccNo(var InvtPostingBuffer: Record "Invt. Posting Buffer";ValueEntry: Record "Value Entry")
    begin
    end;
