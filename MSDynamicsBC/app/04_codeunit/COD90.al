codeunit 90 "Purch.-Post"
{
    ...
    local procedure GetTrackingQuantities(PurchLine: Record "Purchase Line";var TrackingQtyToHandle: Decimal)
    var
        ReservEntry: Record "Reservation Entry";
    begin
        ReservEntry.SetSourceFilter(
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCheckAndUpdate(var PurchaseHeader: Record "Purchase Header";CommitIsSuppressed: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeFinalizePosting(var PurchaseHeader: Record "Purchase Header";var TempPurchLineGlobal: Record "Purchase Line" temporary;EverythingInvoiced: Boolean;CommitIsSupressed: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeInsertReceiptHeader(var PurchHeader: Record "Purchase Header";PurchRcptHeader: Record "Purch. Rcpt. Header";var IsHandled: Boolean;CommitIsSuppressed: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnFillInvoicePostBufferOnAfterInitAmounts(PurchHeader: Record "Purchase Header";PurchLine: Record "Purchase Line";PurchLineACY: Record "Purchase Line";var TempInvoicePostBuffer: Record "Invoice Post. Buffer" temporary;var InvoicePostBuffer: Record "Invoice Post. Buffer";TotalAmount: Decimal;TotalAmountACY: Decimal)
    begin
    end;
