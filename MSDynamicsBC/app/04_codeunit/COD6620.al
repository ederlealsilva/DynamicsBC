codeunit 6620 "Copy Document Mgt."
{
    ...
    begin
        ...
        with ToPurchHeader do begin
          ...
          if FromPurchLineArchive.Find('-') then
            repeat
              CopyArchPurchLine(
                ToPurchHeader,ToPurchLine,FromPurchHeaderArchive,FromPurchLineArchive,
    ...
    local procedure CopyArchSalesLine(var ToSalesHeader: Record "Sales Header";var ToSalesLine: Record "Sales Line";var FromSalesHeaderArchive: Record "Sales Header Archive";var FromSalesLineArchive: Record "Sales Line Archive";var NextLineNo: Integer;var LinesNotCopied: Integer;RecalculateAmount: Boolean)
    var
        ToSalesLine2: Record "Sales Line";
        VATPostingSetup: Record "VAT Posting Setup";
        FromSalesHeader: Record "Sales Header";
    ...
    local procedure CopyArchPurchLine(var ToPurchHeader: Record "Purchase Header";var ToPurchLine: Record "Purchase Line";var FromPurchHeaderArchive: Record "Purchase Header Archive";var FromPurchLineArchive: Record "Purchase Line Archive";var NextLineNo: Integer;var LinesNotCopied: Integer;RecalculateAmount: Boolean)
    var
        ToPurchLine2: Record "Purchase Line";
        VATPostingSetup: Record "VAT Posting Setup";
        FromPurchHeader: Record "Purchase Header";
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCopySalesLineFromSalesLineBuffer(var ToSalesLine: Record "Sales Line";FromSalesInvLine: Record "Sales Invoice Line";IncludeHeader: Boolean;RecalculateLines: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyPurchLineFromPurchLineBuffer(var ToPurchLine: Record "Purchase Line";FromPurchInvLine: Record "Purch. Inv. Line";IncludeHeader: Boolean;RecalculateLines: Boolean)
    begin
    end;
