codeunit 5815 "Undo Sales Shipment Line"
{
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterUpdateSalesLine(var SalesLine: Record "Sales Line";SalesShptLine: Record "Sales Shipment Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeCheckSalesShptLine(SalesShipmentLine: Record "Sales Shipment Line")
    begin
    end;
