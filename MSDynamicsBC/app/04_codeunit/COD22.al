codeunit 22 "Item Jnl.-Post Line"
{
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeCheckItemTrackingInfo(var ItemJnlLine2: Record "Item Journal Line";var TrackingSpecification: Record "Tracking Specification";SNInfoRequired: Boolean;LotInfoRequired: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnGetValuationDateOnBeforeFindOldValueEntry(var OldValueEntry: Record "Value Entry")
    begin
    end;
