codeunit 80 "Sales-Post"
{
    ...
    local procedure PostGLAndCustomer(SalesHeader: Record "Sales Header";var TempInvoicePostBuffer: Record "Invoice Post. Buffer" temporary;var CustLedgEntry: Record "Cust. Ledger Entry")
    begin
    ...
    local procedure GetTrackingQuantities(SalesLine: Record "Sales Line";var TrackingQtyToHandle: Decimal)
    var
        ReservEntry: Record "Reservation Entry";
    begin
        ReservEntry.SetSourceFilter(
    ...
    begin
        ...
        TempPrepaymentSalesLine.DeleteAll;
        TempItemChargeAssgntSales.DeleteAll;
        TempHandlingSpecification.DeleteAll;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCheckAndUpdate(var SalesHeader: Record "Sales Header";CommitIsSuppressed: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCheckTrackingAndWarehouseForShip(var SalesHeader: Record "Sales Header";var Ship: Boolean;CommitIsSuppressed: Boolean;var TempWhseShptHeader: Record "Warehouse Shipment Header" temporary;var TempWhseRcptHeader: Record "Warehouse Receipt Header" temporary)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterIncrAmount(var TotalSalesLine: Record "Sales Line";SalesLine: Record "Sales Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterPostCustomerEntry(var GenJnlLine: Record "Gen. Journal Line";SalesHeader: Record "Sales Header";var TotalSalesLine: Record "Sales Line";var TotalSalesLineLCY: Record "Sales Line";CommitIsSuppressed: Boolean;var GenJnlPostLine: Codeunit "Gen. Jnl.-Post Line")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterPostSalesLine(SalesHeader: Record "Sales Header";var SalesLine: Record "Sales Line";CommitIsSuppressed: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeFinalizePosting(var SalesHeader: Record "Sales Header";var TempSalesLineGlobal: Record "Sales Line" temporary;EverythingInvoiced: Boolean;SuppressCommit: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeItemJnlPostLine(var ItemJournalLine: Record "Item Journal Line";SalesLine: Record "Sales Line";SalesHeader: Record "Sales Header";CommitIsSuppressed: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforePostCustomerEntry(var GenJnlLine: Record "Gen. Journal Line";SalesHeader: Record "Sales Header";var TotalSalesLine: Record "Sales Line";var TotalSalesLineLCY: Record "Sales Line";CommitIsSuppressed: Boolean;PreviewMode: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforePostGLAndCustomer(SalesHeader: Record "Sales Header";var TempInvoicePostBuffer: Record "Invoice Post. Buffer" temporary;var CustLedgerEntry: Record "Cust. Ledger Entry";CommitIsSuppressed: Boolean;PreviewMode: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCheckTrackingAndWarehouseForShipOnBeforeCheck(var SalesHeader: Record "Sales Header";var TempWhseShipmentHeader: Record "Warehouse Shipment Header" temporary;var TempWhseReceiptHeader: Record "Warehouse Receipt Header" temporary;var Ship: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnPostItemChargePerOrderOnAfterCopyToItemJnlLine(var ItemJournalLine: Record "Item Journal Line";var SalesLine: Record "Sales Line";GeneralLedgerSetup: Record "General Ledger Setup";QtyToInvoice: Decimal)
    begin
    end;
}
