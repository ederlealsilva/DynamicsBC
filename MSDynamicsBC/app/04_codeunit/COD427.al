codeunit 427 ICInboxOutboxMgt
{
    ...
    [Scope('Personalization')]
    procedure ICOutboxTransactionCreated(var ICOutboxTransaction: Record "IC Outbox Transaction")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCreatePurchDocument(PurchaseHeader: Record "Purchase Header";ICInboxPurchaseHeader: Record "IC Inbox Purchase Header";HandledICInboxPurchHeader: Record "Handled IC Inbox Purch. Header")
    begin
    end;
