codeunit 7111 "Insert Analysis Line"
{
    ...
    local procedure InsertAnalysisLine(var AnalysisLine: Record "Analysis Line";var AnalysisLineNo: Integer;Text: Text[50];No: Code[20];Type2: Integer;Bold2: Boolean;Indent: Integer)
    begin
        with AnalysisLine do begin
          Init;
