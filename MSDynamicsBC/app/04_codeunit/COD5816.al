codeunit 5816 "Undo Return Receipt Line"
{
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterUpdateSalesLine(ReturnRcptLine: Record "Return Receipt Line";SalesLine: Record "Sales Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeCheckReturnRcptLine(ReturnReceiptLine: Record "Return Receipt Line")
    begin
    end;
}
