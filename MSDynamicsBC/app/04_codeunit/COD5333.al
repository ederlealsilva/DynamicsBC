codeunit 5333 "CRM Integration Telemetry"
{
    ...
    var
        ...
        EnabledConnectionTelemetryTxt: Label '{"Enabled": "Yes", "AuthenticationType": "%1", "CRMVersion": "%2", "ProxyVersion": "%3", "CRMSolutionInstalled": "%4", "SOIntegration": "%5", "AutoCreateSO": "%6", "UsersMapRequired": "%7", "ItemAvailablityEnabled": "%8"}', Locked=true;
        ...
        with CRMConnectionSetup do
          exit(
            StrSubstNo(
              ...
              "Is S.Order Integration Enabled","Auto Create Sales Orders","Is User Mapping Required",
              CRMIntegrationManagement.IsItemAvailabilityWebServiceEnabled));
    end;
