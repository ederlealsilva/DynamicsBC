codeunit 64 "Sales-Get Shipment"
{
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeTransferLineToSalesDoc(SalesShipmentHeader: Record "Sales Shipment Header";SalesShipmentLine: Record "Sales Shipment Line";SalesHeader: Record "Sales Header";var TransferLine: Boolean)
    begin
    end;
