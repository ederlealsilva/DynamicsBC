codeunit 1250 "Match General Journal Lines"
{
    ...
    local procedure GetMatchScore(GenJournalLine: Record "Gen. Journal Line";DocumentNo: Code[20];CustVendorNo: Code[20];ExternalDocNo: Code[35];CustVendorName: Text[50];RemainingAmountLCY: Decimal;PreferredSign: Integer;EntryPostingDate: Date): Integer
    var
        Score: Integer;
    begin
    ...
    local procedure GetDescriptionMatchScore(Description: Text;DocumentNo: Code[20];CustVendorNo: Code[20];ExternalDocNo: Code[35];CustVendorName: Text[50]): Integer
    var
        RecordMatchMgt: Codeunit "Record Match Mgt.";
        Score: Integer;
        Nearness: Integer;
