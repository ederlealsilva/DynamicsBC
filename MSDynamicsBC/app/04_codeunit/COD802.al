codeunit 802 "Online Map Management"
{
    ...
    local procedure SetParameters(var RecordRef: RecordRef;var Parameters: array [12] of Text[50];AddressFieldNo: Integer;CityFieldNo: Integer;CountyFieldNo: Integer;PostCodeFieldNo: Integer;CountryCodeFieldNo: Integer)
    var
        FieldRef: FieldRef;
    begin
    ...
    local procedure OnAfterGetAddress(TableID: Integer;RecPosition: Text;var Parameters: array [12] of Text[50];var RecordRef: RecordRef)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeGetAddress(TableID: Integer;RecPosition: Text;var Parameters: array [12] of Text[50];var IsHandled: Boolean)
    begin
    end;
