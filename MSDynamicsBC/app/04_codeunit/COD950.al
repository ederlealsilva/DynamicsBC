codeunit 950 "Time Sheet Management"
{
    ...
    local procedure CreateTSLineFromDocLine(TableID: Integer;ResourceNo: Code[20];PostingDate: Date;DocumentNo: Code[20];OrderNo: Code[20];OrderLineNo: Integer;WorkTypeCode: Code[10];Chargbl: Boolean;Desc: Text[50];Quantity: Decimal)
    var
        Resource: Record Resource;
        TimeSheetHeader: Record "Time Sheet Header";
        TimeSheetLine: Record "Time Sheet Line";
    ...
    [Scope('Personalization')]
    procedure CreateTSPostingEntry(TimeSheetDetail: Record "Time Sheet Detail";Qty: Decimal;PostingDate: Date;DocumentNo: Code[20];Desc: Text[50])
    var
