codeunit 6300 "Azure AD Mgt."
{
    ...
    procedure GetOnBehalfAccessTokenAndRefreshToken(ResourceUrl: Text;var RefreshToken: Text): Text
    var
        AzureADAuthFlow: Codeunit "Azure AD Auth Flow";
    begin
        AzureADAuthFlow.Initialize(GetRedirectUrl);
        exit(AzureADAuthFlow.AcquireOnBehalfOfTokenAndRefreshToken(ResourceUrl,RefreshToken));
    end;

    procedure GetTokenFromRefreshToken(RefreshToken: Text;var NewRefreshToken: Text): Text
    var
        AzureADAuthFlow: Codeunit "Azure AD Auth Flow";
    begin
        AzureADAuthFlow.Initialize(GetRedirectUrl);
        exit(AzureADAuthFlow.AcquireTokenFromRefreshToken(RefreshToken,NewRefreshToken));
    end;
