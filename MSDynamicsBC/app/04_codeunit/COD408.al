codeunit 408 DimensionManagement
{
    ...
    var
        ...
        OverflowDimFilterErr: Label 'Conversion of dimension filter results in a filter that becomes too long.';
    ...
    var
        ...
        TempDimensionValueBuffer: Record "Dimension Value" temporary;
    begin
    ...
    local procedure GetDimValuesWithTotalings(var TempDimensionValue: Record "Dimension Value" temporary;DimValueFilter: Text;DimensionCode: Code[20])
    var
    ...
    local procedure FillTempDimensionValueBuffer(var TempDimensionValue: Record "Dimension Value" temporary;var TempDimensionValueBuffer: Record "Dimension Value" temporary;DimValueFilter: Text;DimensionCode: Code[20])
    var
        DimensionValue: Record "Dimension Value";
    begin
    ...
    local procedure GetFilterFromDimValuesTable(var TempDimensionValue: Record "Dimension Value" temporary;var TempDimensionValueBuffer: Record "Dimension Value" temporary;var DimValueFilter: Text)
    var
    ...
    local procedure AddRangeToFilter(var DimValueFilter: Text;RangeStartCode: Code[20];RangeEndCode: Code[20];var RangeStarted: Boolean)
    begin
