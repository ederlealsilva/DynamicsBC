        ...
        area(content)
        {
            repeater(Control5)
            {
                ...
                field(ReadTxt;ReadTxt)
                {
                    ...
                    ToolTip = 'Specifies the users''s read permission with this permission set. ';
                ...
                field(InsertTxt;InsertTxt)
                {
                    ...
                    TableRelation = "Option Lookup Buffer"."Option Caption" WHERE ("Lookup Type"=CONST(Permissions));
                    ToolTip = 'Specifies the users''s insert permission with this permission set.';
                ...
                field(ModifyTxt;ModifyTxt)
                {
                    ...
                    TableRelation = "Option Lookup Buffer"."Option Caption" WHERE ("Lookup Type"=CONST(Permissions));
                    ToolTip = 'Specifies the users''s modify permission with this permission set.';
                ...
                field(DeleteTxt;DeleteTxt)
                {
                    ...
                    TableRelation = "Option Lookup Buffer"."Option Caption" WHERE ("Lookup Type"=CONST(Permissions));
                    ToolTip = 'Specifies the users''s delete permission with this permission set.';
                ...
                field(ExecuteTxt;ExecuteTxt)
                {
                    ...
                    TableRelation = "Option Lookup Buffer"."Option Caption" WHERE ("Lookup Type"=CONST(Permissions));
                    ToolTip = 'Specifies the users''s execute permission with this permission set.';
