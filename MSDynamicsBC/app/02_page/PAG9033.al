page 9033 "Invite External Accountant"
{
    ...
    var
        ...
        EmailUseThisLinkWhenAddingClientTxt: Label 'Navigate to the link below to verify you can log in. Then you can use the same link when adding this client in your Accountant Hub.';
