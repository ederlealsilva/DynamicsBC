    ...
    layout
    {
        area(content)
        {
            ...
            field(GrossReq;GrossReq)
            {
                ...
                DecimalPlaces = 0:5;
                Editable = false;
                ToolTip = 'Specifies dependent demand plus independent demand. Dependent demand comes from production order components of all statuses, assembly order components, and planning lines. Independent demand comes from sales orders, transfer orders, service orders, job tasks, and production forecasts.';
                Visible = GrossReq <> 0;
            }
