page 1393 "Trial Balance"
{
    ...
    trigger OnOpenPage()
    begin
        if TryLoadTrialBalanceData then
          SetStyles
        else
          IsError := true;
    end;
