    ...
    actions
    {
        area(reporting)
        {
            ...
            action("Whse. P&hys. Inventory List")
            {
                ...
                ToolTip = 'View or print the list of the lines that you have calculated in the Warehouse Pgysical Inventory Journal window. You can use this report during the physical inventory count to mark down actual quantities on hand in the warehouse and compare them to what is recorded in the program.';
            }
