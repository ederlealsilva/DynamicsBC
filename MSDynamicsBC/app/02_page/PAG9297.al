page 9297 "Inventory - G/L Recon Matrix"
{
    ...
    procedure Load(MatrixColumns1: array [32] of Text[80];var MatrixRecords1: array [32] of Record "Dimension Code Buffer";CurrentNoOfMatrixColumns: Integer;ShowWarningLocal: Boolean;DateFilterLocal: Text;ItemFilterLocal: Text;LocationFilterLocal: Text)
    begin
