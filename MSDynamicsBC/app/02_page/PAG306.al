page 306 "Report Selection - Sales"
{
    ...
    layout
    {
        area(content)
        {
            field(ReportUsage;ReportUsage2)
            {
                ApplicationArea = Basic,Suite;
                Caption = 'Usage';
                OptionCaption = 'Quote,Blanket Order,Order,Invoice,Work Order,Return Order,Credit Memo,Shipment,Return Receipt,Sales Document - Test,Prepayment Document - Test,S.Arch. Quote,S.Arch. Order,S. Arch. Return Order,Pick Instruction,Customer Statement,Draft Invoice,Pro Forma Invoice,S. Arch. Blanket Order';
    ...
    var
        ReportUsage2: Option Quote,"Blanket Order","Order",Invoice,"Work Order","Return Order","Credit Memo",Shipment,"Return Receipt","Sales Document - Test","Prepayment Document - Test","S.Arch. Quote","S.Arch. Order","S. Arch. Return Order","Pick Instruction","Customer Statement","Draft Invoice","Pro Forma Invoice","S. Arch. Blanket Order";
