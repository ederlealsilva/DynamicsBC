page 1877 "VAT Setup Wizard"
{
    ...
    local procedure AddVATProdPostingGroups(GroupCode: Code[20];GroupDesc: Text[50])
    var
    ...
    local procedure AddVATBusPostingGrp(VATBusPostingCode: Code[20];VATBusPostingDesc: Text[50])
    var
