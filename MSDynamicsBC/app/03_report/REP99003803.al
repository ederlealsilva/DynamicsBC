                ...
                group(Options)
                {
                    ...
                    group("Copy to")
                    {
                        ...
                        field(ProductionForecastName;ToProdForecastEntry."Production Forecast Name")
                        {
                            ...
                            ToolTip = 'Specifies the name of the production forecast to which you want to copy the entries. Before you can select a production forecast name, it must be set up in the Production Forecast Names window, which you open by clicking the field.';
                        }
                        ...
                        field(LocationCode;ToProdForecastEntry."Location Code")
                        {
                            ...
                            ToolTip = 'Specifies a location for the production forecast to which you are copying entries.';
                        }
                    }
