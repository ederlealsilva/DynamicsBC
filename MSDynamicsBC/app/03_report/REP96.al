report 96 "Copy G/L Budget"
{
    ...
    local procedure ProcessRecord(GLAccNo: Code[20];BUCode: Code[20];PostingDate: Date;PostingDescription: Text[50];DimSetID: Integer;Amount: Decimal)
    var
        NewDate: Date;
        NewDimSetID: Integer;
    begin
    ...
    local procedure UpdateTempGLBudgetEntry(GLAccNo: Code[20];PostingDate: Date;Amount: Decimal;Description: Text[50];BUCode: Code[20];DimSetID: Integer)
    begin
