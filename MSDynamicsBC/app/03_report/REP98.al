report 98 "Date Compress General Ledger"
{
    ...
    var
        Text000: Label 'This batch job deletes entries. Therefore, it is important that you make a backup of the database before you run the batch job.\\';
        Text002: Label 'Do you want to date compress the entries?';
