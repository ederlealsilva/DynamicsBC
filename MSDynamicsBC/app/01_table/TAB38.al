table 38 "Purchase Header"
{
    ...
    begin
        if PurchLinesExist and not GetHideValidationDialog then
          Message(
            Text019 +
            Text020,
            ChangedFieldName);
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterGetNoSeriesCode(var PurchHeader: Record "Purchase Header";PurchSetup: Record "Purchases & Payables Setup";NoSeriesCode: Code[20])
    begin
    end;
