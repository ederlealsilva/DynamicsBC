table 36 "Sales Header"
{
    ...
    local procedure CopyReservEntryToTemp(OldSalesLine: Record "Sales Line")
    begin
        ReservEntry.Reset;
    ...
    local procedure CopyReservEntryFromTemp(OldSalesLine: Record "Sales Line";NewSourceRefNo: Integer)
    begin
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterUpdateShipToAddress(var SalesHeader: Record "Sales Header")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeRecreateSalesLines(var pioSalesHeader: Record "Sales Header")
    begin
    end;
