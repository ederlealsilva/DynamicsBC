table 5715 "Item Substitution"
{
    ...
    local procedure GetItemVariantDescription(): Text[50]
    var
        Item: Record Item;
    begin
    ...
    [Scope('Personalization')]
    procedure SetDescription(Type: Integer;Number: Code[20];var Description: Text[50])
    var
        Item: Record Item;
    ...
    [Scope('Personalization')]
    procedure SetItemVariantDescription(Type: Integer;Number: Code[20];Variant: Code[10];var Description: Text[50])
    var
        Item: Record Item;
        NonstockItem: Record "Nonstock Item";
        ItemVariant: Record "Item Variant";
