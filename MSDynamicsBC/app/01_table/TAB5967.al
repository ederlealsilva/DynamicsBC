table 5967 "Contract Change Log"
{
    ...
    procedure LogContractChange(ContractNo: Code[20];ContractPart: Option Header,Line,Discount;FieldName: Text[80];ChangeType: Integer;OldValue: Text[80];NewValue: Text[80];ServItemNo: Code[20];ServContractLineNo: Integer)
    begin
