table 6651 "Return Shipment Line"
{
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInsertInvLineFromRetShptLine(var PurchLine: Record "Purchase Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeInsertInvLineFromRetShptLine(var PurchLine: Record "Purchase Line";var PurchOrderLine: Record "Purchase Line")
    begin
    end;
}
