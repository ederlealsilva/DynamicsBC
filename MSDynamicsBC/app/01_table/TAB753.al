table 753 "Standard Item Journal Line"
{
    ...
    local procedure OnAfterCreateDimTableIDs(var StandardItemJournalLine: Record "Standard Item Journal Line";FieldNo: Integer;var TableID: array [10] of Integer;var No: array [10] of Code[20])
    begin
    end;
}
