table 313 "Inventory Setup"
{
    ...
    var
        ...
        Text001: Label 'If you change the %1, the program must adjust all item entries.';
        Text002: Label 'The adjustment of all entries can take several hours.\';
        Text003: Label 'Do you really want to change the %1?';
