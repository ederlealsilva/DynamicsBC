table 303 "Finance Charge Memo Line"
{
    ...
    procedure OnAfterCalcFinCharge(var FinanceChargeMemoLine: Record "Finance Charge Memo Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    procedure OnBeforeCalcFinCharge(var FinanceChargeMemoLine: Record "Finance Charge Memo Line")
    begin
    end;
}
