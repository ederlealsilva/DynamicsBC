table 751 "Standard General Journal Line"
{
    ...
    local procedure OnAfterCreateDimTableIDs(var StandardGenJournalLine: Record "Standard General Journal Line";FieldNo: Integer;var TableID: array [10] of Integer;var No: array [10] of Code[20])
    begin
    end;
}
