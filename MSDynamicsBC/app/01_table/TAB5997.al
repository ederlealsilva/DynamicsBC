table 5997 "Standard Service Line"
{
    ...
    local procedure OnAfterCreateDimTableIDs(var StandardServiceLine: Record "Standard Service Line";FieldNo: Integer;var TableID: array [10] of Integer;var No: array [10] of Code[20])
    begin
    end;
}
