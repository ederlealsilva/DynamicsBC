table 5635 "Insurance Journal Line"
{
    ...
    local procedure OnAfterCreateDimTableIDs(var InsuranceJournalLine: Record "Insurance Journal Line";FieldNo: Integer;var TableID: array [10] of Integer;var No: array [10] of Code[20])
    begin
    end;
}
