table 1706 "Deferral Posting Buffer"
{
    ...
    keys
    {
        ...
        key(Key2;Type,"G/L Account","Gen. Bus. Posting Group","Gen. Prod. Posting Group","VAT Bus. Posting Group","VAT Prod. Posting Group","Tax Area Code","Tax Group Code","Tax Liable","Use Tax","Dimension Set ID","Job No.","Deferral Code","Posting Date","Partial Deferral")
        {
        }
        key(Key3;"Deferral Doc. Type","Document No.","Deferral Line No.")
        {
        }
    }
