table 6661 "Return Receipt Line"
{
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeInsertInvLineFromRetRcptLineBeforeInsertTextLine(var ReturnReceiptLine: Record "Return Receipt Line";SalesLine: Record "Sales Line";var NextLineNo: Integer;var IsHandled: Boolean)
    begin
    end;
}
