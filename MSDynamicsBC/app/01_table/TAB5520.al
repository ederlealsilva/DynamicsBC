table 5520 "Unplanned Demand"
{
    ...
    procedure InitRecord(DemandLineNo: Integer;DemandRefNo: Integer;ItemNo: Code[20];ItemDescription: Text[50];VariantCode: Code[10];LocationCode: Code[10];BinCode: Code[20];UoMCode: Code[10];QtyPerUoM: Decimal;QtyBase: Decimal;DemandDate: Date)
    begin
